...
var G__14147 = o;
goog.object.set(G__14147,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__14148__delegate = function (args){
...
while (G__14149__i < G__14149__a.length) {G__14149__a[G__14149__i] = arguments[G__14149__i + 0]; ++G__14149__i;}
  args = new cljs.core.IndexedSeq(G__14149__a,0,null);
} 
return G__14148__delegate.call(this,args);};
...
return G__14148__delegate(args);
});
...
var G__14151 = o;
goog.object.set(G__14151,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__14152__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__14153__i < G__14153__a.length) {G__14153__a[G__14153__i] = arguments[G__14153__i + 0]; ++G__14153__i;}
  args = new cljs.core.IndexedSeq(G__14153__a,0,null);
} 
return G__14152__delegate.call(this,args);};
...
return G__14152__delegate(args);
});
...
var G__14155 = props;
var G__14155__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__14155,cljs.core.cst$kw$id,id):G__14155);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__14155__$1,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__14155__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__14156 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__14156,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__14156;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__14157){
var map__14158 = p__14157;
var map__14158__$1 = (((((!((map__14158 == null))))?(((((map__14158.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__14158.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__14158):map__14158);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14158__$1,cljs.core.cst$kw$on_DASH_write);
...
return (jsprops.onChange = (function (p1__14160_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__14160_SHARP_);
}));
} else {
return null;
}
...
var vec__14163 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14163,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14163,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14163,(2),null);
...
var temp__5724__auto___14167 = reagent.impl.template.key_from_vec(v);
if((temp__5724__auto___14167 == null)){
} else {
var key_14168 = temp__5724__auto___14167;
(jsprops.key = key_14168);
}
...
var temp__5724__auto___14169 = reagent.impl.template.key_from_vec(argv);
if((temp__5724__auto___14169 == null)){
} else {
var key_14170 = temp__5724__auto___14169;
(jsprops.key = key_14170);
}
...
var G__14171 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__14171) : reagent.impl.template.as_element.call(null,G__14171));
} else {
var temp__5724__auto___14172 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5724__auto___14172 == null)){
} else {
var key_14173 = temp__5724__auto___14172;
(jsprops.key = key_14173);
}
...
var G__14175 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__14175)){
return x;
} else {
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq14176){
var G__14177 = cljs.core.first(seq14176);
var seq14176__$1 = cljs.core.next(seq14176);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__14177,seq14176__$1);
}));
...
break;
default:
var G__14183 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__14183;
continue;
...
var ctx = ({});
var vec__14185 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14185,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14185,(1),null);
...
var G__14188 = (cljs.core.count(argv) - first_child);
switch (G__14188) {
case (0):
...
break;
case (1):
var G__14189 = component;
var G__14190 = jsprops;
var G__14191 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return reagent.impl.template.global$module$react.createElement(G__14189,G__14190,G__14191);
